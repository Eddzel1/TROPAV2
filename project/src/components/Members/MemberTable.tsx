                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap gap-1 mt-2">
                      <span className={`inline-flex px-2 py-1 text-xs font-medium rounded-full ${sectorColors[member.sector]}`}>{member.sector}</span>
          ...
          <tbody>
            {members.map((member) => (
              <tr key={member.id} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                ...
                <td className="p-4"><span className={`inline-flex px-2 py-1 text-xs font-medium rounded-full ${sectorColors[member.sector]}`}>{member.sector}</span></td>
